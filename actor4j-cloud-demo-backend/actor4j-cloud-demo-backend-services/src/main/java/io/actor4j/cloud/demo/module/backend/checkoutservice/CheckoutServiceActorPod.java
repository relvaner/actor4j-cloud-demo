...
public class CheckoutServiceActorPod extends DefaultRemoteActorPod {
	public CheckoutServiceActorPod() {
		super();
	}

	@Override
	public String domain() {
		return PodAlias.CheckoutService;
	}

	@Override
	public ActorFactory factory(UUID groupId, PodContext context) {
		return () -> new CheckoutServiceActor(groupId, context);
	}
}
