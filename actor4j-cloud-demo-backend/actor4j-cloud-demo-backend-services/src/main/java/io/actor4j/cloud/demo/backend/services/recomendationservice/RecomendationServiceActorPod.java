...
public class RecomendationServiceActorPod extends DefaultRemoteActorPod {
	public RecomendationServiceActorPod() {
		super();
	}

	@Override
	public String domain() {
		return PodAlias.RecomendationService;
	}

	@Override
	public ActorFactory factory(UUID groupId, PodContext context) {
		return () -> new RecomendationServiceActor(groupId, context);
	}
}
