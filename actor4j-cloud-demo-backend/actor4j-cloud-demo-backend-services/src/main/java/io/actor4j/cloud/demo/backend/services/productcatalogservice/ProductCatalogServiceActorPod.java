...
public class ProductCatalogServiceActorPod extends DefaultRemoteActorPod {
	public ProductCatalogServiceActorPod() {
		super();
	}

	@Override
	public String domain() {
		return PodAlias.ProductCatalogService;
	}

	@Override
	public ActorFactory factory(UUID groupId, PodContext context) {
		return () -> new ProductCatalogServiceActor(groupId, context);
	}
}
